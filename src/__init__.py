...
import AST_Rock_Website.dashboard.CoreEngine.src.open_issue_classification as classifier
...
from AST_Rock_Website.dashboard.CoreEngine.src.open_issue_classification import get_open_issues as git_helper_get_open_issues
